            ...
            ne = Dn(
                o.convertOffsetParentRelativeRectToViewportRelativeRect
                    ? await o.convertOffsetParentRelativeRectToViewportRelativeRect(
                          { elements: c, rect: A, offsetParent: N, strategy: f }
                      )
                    : A
            );
        return {
        ...
        async fn(t) {
            ...
            let de = Y / 2 - ne / 2,
                ...
                j =
                    ...
                    xt(i) != null &&
                    v !== p &&
                    o.reference[S] / 2 - (v < l ? Q : me) - M[S] / 2 < 0,
                P = j ? (v < l ? v - l : v - h) : 0;
            return {
                [E]: O[E] + P,
                data: {
            ...
            e.directive(
                ...
                (
                    ...
                    let m = (V) =>
                        ...
                        M = S.querySelectorAll(`[\\@click^="$refs.${E}"]`),
    ...
    function as(e) {
        ...
        if (((t = t || (r && r[st])), !!t)) {
            ...
            (window.CustomEvent && !Wt && !er
                ...
                (M.originalEvent = O),
                (M.pullMode = E ? E.lastPutMode : void 0));
        ...
        _s = Bo((e) => {
            ...
            function A(d, s) {
                ...
                var _ = $(d),
                    ...
                    F = r(_),
                    U = T
                        ? [F].concat(F.visualViewport || [], E(_) ? _ : [])
                        : _,
                    H = s.concat(U);
            ...
            function cn(g, w) {
                ...
                function Me() {
                    (Jt() &&
                        ...
                        M(x.props.trigger).forEach(function (D) {
                            if (D !== 'manual')
                                switch ((xe(D, Be), D)) {
                                    case 'mouseenter':
                                        xe('mouseleave', He);
                        ...
                        for (let [a, c] of Object.entries(
                            ...
                            ((O.__livewire = t.component),
                                window.Alpine.morph(u, O, {
                                    ...
                                    key: (E) => {
                                        if (!n(E))
                                            return E.hasAttribute('wire:key')
                                                ? E.getAttribute('wire:key')
                                                : E.hasAttribute('wire:id')
                                                  ? E.getAttribute('wire:id')
                                                  : E.id;
                                    },
                                    lookahead: !1,
                                }));
