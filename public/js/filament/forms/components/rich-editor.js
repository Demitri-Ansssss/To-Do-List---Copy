...
function Ua(t, e, n) {
    ...
    return (
        ...
        e > 0 &&
            ...
            n <= 0 &&
                (r = r.append(
                    t.type.contentMatch.matchFragment(r).fillBefore(v.empty, !0)
                ))),
        t.copy(r)
    );
}
...
function fc(t, e, n, r) {
    ...
    if (
        ...
        if (n) {
            ...
            p = v.from(o.copy(p));
            let m = t.tr.step(
                    new se(e.pos - 1, h, e.pos, h, new E(p, 1, 0), s.length, !0)
                ),
            ...
            (l =
                e < 0
                    ? s
                          ...
                          .append(l)
                    : l.append(
                          s.contentMatchAt(s.childCount).fillBefore(v.empty, !0)
                      )),
        ...
        parseMarkdown: (t, e) => {
            ...
            if (
                (t.tokens && t.tokens.length > 0
                    ? n.push(
                          e.createNode('paragraph', {}, e.parseInline(t.tokens))
                      )
                    : t.text
                      ? n.push(
